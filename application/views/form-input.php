...
<div class="login-box">
<img src="my1.JPG" class="avatar" />

	<h1>New Reservation</h1>
     
	<form action="<?php echo site_url('welcome/insert')?>" method="POST">
    <p>Table</p>
    <input type="text" name="kode" placeholder="Mau table dimana?"/><br>
    <p>Nama</p>
    <input type="text" name="username" placeholder="Masukan namamu.."/><br>
    <p>Jam Datang</p> 
    <input type="text" name="password" placeholder="Kamu datang jam berapa?"/> <br>
